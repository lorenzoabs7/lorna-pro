import { r as removeBase, i as isCoreRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from './astro/assets-service_BYZOkCHs.mjs';
import { A as AstroError, q as UnknownContentCollectionError, e as createComponent, s as renderUniqueStylesheet, t as renderScriptElement, v as createHeadAndContent, r as renderComponent, f as renderTemplate, u as unescapeHTML } from './astro/server_9P8XkXq2.mjs';
import { u as unflatten } from './parse_D11HZoK7.mjs';
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://lornadev.com", "SSR": true};
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/solutions/automation-workflows.mdx": () => import('./automation-workflows_BY45cjZ5.mjs'),"/src/content/solutions/performance-optimization.mdx": () => import('./performance-optimization_DTb90mjG.mjs'),"/src/content/solutions/system-architecture.mdx": () => import('./system-architecture_DF7MmCpZ.mjs'),"/src/content/work/api-performance-optimization.mdx": () => import('./api-performance-optimization_Dh8jab2j.mjs'),"/src/content/work/cicd-modernization.mdx": () => import('./cicd-modernization_C6vYZpQF.mjs')});
...
let lookupMap = {};
lookupMap = {"solutions":{"type":"content","entries":{"automation-workflows":"/src/content/solutions/automation-workflows.mdx","system-architecture":"/src/content/solutions/system-architecture.mdx","performance-optimization":"/src/content/solutions/performance-optimization.mdx"}},"work":{"type":"content","entries":{"cicd-modernization":"/src/content/work/cicd-modernization.mdx","api-performance-optimization":"/src/content/work/api-performance-optimization.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/solutions/automation-workflows.mdx": () => import('./automation-workflows_BFtuB68I.mjs'),"/src/content/solutions/performance-optimization.mdx": () => import('./performance-optimization_DeqATurr.mjs'),"/src/content/solutions/system-architecture.mdx": () => import('./system-architecture_CRkTieRH.mjs'),"/src/content/work/api-performance-optimization.mdx": () => import('./api-performance-optimization_CoKWw6TT.mjs'),"/src/content/work/cicd-modernization.mdx": () => import('./cicd-modernization_2XlN3ZzE.mjs')});
